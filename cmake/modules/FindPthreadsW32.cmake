...
if(WIN32)
    ...
    message(AUTHOR_WARNING ${PTHREADS_PATH})
    message(AUTHOR_WARNING ${PTHREADS_LIBRARY_PATH_SUFFIX})
    message(AUTHOR_WARNING ${PTHREADS_HEADER_FILE})
    message(AUTHOR_WARNING ${PTHREADS_INCLUDE_DIRS})
    message(AUTHOR_WARNING ${pthread_LIBRARY})
